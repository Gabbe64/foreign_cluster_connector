...
type ApiV1beta1Interface interface {
	...
	ForeignClusterConnectionsGetter
}
...
func (c *ApiV1beta1Client) ForeignClusterConnections(namespace string) ForeignClusterConnectionInterface {
	return newForeignClusterConnections(c, namespace)
}
